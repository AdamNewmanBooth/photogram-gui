...
def delete
  ...
  #render({:template =>"photos_templates/delete"})
  redirect_to("/photos")
end
...
def update
  edit_image = params.fetch("input_image")
  edit_caption = params.fetch("input_caption")
  ...
  the_photo.image = edit_image

  the_photo.caption = edit_caption
